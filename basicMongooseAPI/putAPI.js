...
app.put("/delete/:_id", async (req, res) => {
  // use insertOne() method to update the single product from the database
  let data = await product.insertOne(req.params); // insertOne() method also returns the promise - to handle that promise we use async/await
